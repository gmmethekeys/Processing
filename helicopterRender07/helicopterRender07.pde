...
void draw() {
  ...
  helicopterlives = "lives: " + helicopter.helicopterLife;
  textFont(font,30);
  text(scoreNumber,40,40);
  text(helicopterlives, width-100,height-40);
...
if (score == 100) {
    ...
    text("You've Won Level 2!", width/2, height/2);
  }
  ...
  if (score == 50) {
    ...
    text("You've Won Level 1!", width/2, height/2);
  }
if (keyPressed) {
  if (key == 'f' || key == 'F') {
